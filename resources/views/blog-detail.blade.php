...
<body class="relative font-inter">
        ...
        <div class="relative flex w-full" x-data="{ open: false }">
            ...
            <div class="fixed inset-0 flex items-center w-screen h-screen px-20 lg:px-0 bg-white/95 lg:relative lg:w-auto lg:h-auto lg:!flex"
                ...
                <ul class="flex-col items-center gap-10 lg:flex lg:flex-row">
                    <li
                        class="mb-4 text-base font-bold uppercase lg:mb-0 lg:font-semibold lg:text-sm opacity-60 hover:opacity-100 transition-all duration-500">
                        <a href="#">Home</a>
                    </li>
                    <li
                        class="mb-4 text-base font-bold uppercase lg:mb-0 lg:font-semibold lg:text-sm opacity-60 hover:opacity-100 transition-all duration-500">
                    ...
                    <li class="mb-4 text-base font-bold uppercase lg:mb-0 lg:font-semibold lg:text-sm opacity-100"><a
                            href="#">Blog</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="container py-6 lg:py-20 mt-20 lg:mt-0 grid grid-cols-1 lg:grid-cols-2 gap-10 items-end">
        <div class="">
            <h1 class="text-3xl font-bold mb-4">{{ $article->title }}
            </h1>
            <span class="inline-block text-base font-medium mb-4">Diterbitkan
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div class="">
                <img src="{{ asset('dist/img/blog/thumb-example.png') }}" alt=""
                    class="w-full aspect-video rounded mb-6">
                <div class="">
        ...
        <div class="w-10/12 mx-auto">
            <div class="flex flex-col items-center justify-center gap-6 lg:gap-16 lg:flex-row">
                ...
                <div class="flex flex-col order-1 pt-6 text-center lg:py-6 lg:order-2 address">
                    <div class="mb-10">
                        <img src="{{ asset('/dist/img/logo.png') }}" class="mx-auto max-h-8 lg:max-h-12 grayscale"
                            alt="logo deftzone">
                    </div>
