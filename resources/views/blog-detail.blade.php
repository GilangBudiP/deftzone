...
<body class="relative font-inter">
    ...
    <div class="container grid grid-cols-3 gap-10 py-6 border-t border-b border-gray-200">
        <div class="flex flex-col order-2 lg:order-1 col-span-3 lg:col-span-2 gap-6">
            <div class="blog-content px-2 lg:px-6">
                ...
                <p>
                    Salah satu alasan utama mengapa Tailwind CSS menjadi favorit di kalangan developer adalah pendekatannya yang "Utility-First". Daripada menggunakan kelas CSS yang telah ditentukan sebelumnya seperti pada framework lain, Tailwind menghadirkan sejumlah besar kelas utilitas yang dapat digunakan secara langsung dalam HTML. Dengan demikian, para developer memiliki kendali penuh atas desain mereka tanpa harus menulis kode CSS tambahan. Pendekatan ini memungkinkan pengembang untuk lebih fokus pada struktur dan logika komponen daripada menghabiskan waktu untuk menulis atau menyesuaikan gaya CSS.
                </p>
                <h3>
                    2. Ringan dan Cepat
                </h3>
                <p>
                    Tailwind CSS menonjol karena ukurannya yang ringan dan performa yang cepat. Dalam dunia pengembangan web yang semakin mengedepankan kecepatan dan performa, Tailwind CSS menawarkan solusi yang optimal. Framework ini mengandung hanya sejumlah kecil CSS yang diperlukan untuk mendukung kelas utilitasnya, yang berarti file CSS output akan lebih kecil dibandingkan dengan beberapa alternatif framework lainnya. Penggunaan kelas utilitas yang tepat juga dapat mengurangi jumlah permintaan HTTP yang dibutuhkan untuk memuat halaman, meningkatkan kecepatan pemuatan dan pengalaman pengguna.
                </p>
                <h3>
                    3. Fleksibilitas dan Customisasi
                </h3>
                <p>
                    Tailwind CSS menawarkan fleksibilitas tinggi dalam hal tampilan dan gaya desain. Meskipun memiliki banyak kelas utilitas bawaan, Anda tetap dapat dengan mudah menyesuaikan desain sesuai kebutuhan proyek Anda. Tailwind tidak menghadirkan desain baku, tetapi memberikan fondasi yang kuat untuk membangun desain kustom. Dengan menggunakan file konfigurasi, Anda dapat menyesuaikan warna, ukuran, dan lebih banyak elemen desain sesuai preferensi proyek Anda.
                </p>
                <h3>
                    4. Dokumentasi yang Kaya dan Ramah Pengembang
                </h3>
                <p>
                    Tailwind CSS dilengkapi dengan dokumentasi yang sangat baik dan ramah pengembang. Dokumentasi yang komprehensif memudahkan para developer untuk belajar dan menguasai framework ini dengan cepat. Selain itu, dokumentasi yang jelas dan lengkap juga membantu dalam mengeksplorasi berbagai kelas utilitas dan opsi konfigurasi yang ditawarkan oleh Tailwind CSS.
                </p>
                <h3>
                    5. Komunitas yang Aktif dan Solid
                </h3>
                <p>
                    Popularitas Tailwind CSS didukung oleh komunitas yang aktif dan solid. Komunitas ini berkontribusi pada pertumbuhan framework dengan menyediakan beragam plugin dan ekstensi yang dapat membantu pengembang dalam bekerja dengan Tailwind. Forum, grup, dan media sosial komunitas ini juga memberikan dukungan, saran, dan berbagai solusi bagi para developer yang baru mengenal atau berpengalaman dengan Tailwind CSS.
                </p>
                <h3>
                    Kesimpulan
                </h3>
        ...
        <div class="col-span-3 order-1 lg:order-2 lg:col-span-1">
            <div class="p-0 lg:px-8 lg:py-0 sticky top-10">
                <h3 class="text-lg lg:text-2xl font-bold">Table of Contents</h3>
                <ul class="space-y-1.5 lg:space-y-2.5 text-sm lg:text-base font-semibold mt-4 lg:mt-6 text-black/70">
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Pendekatan Utility First</a></li>
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Ringan dan Cepat</a></li>
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Fleksibilitas dan Customisasi</a></li>
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Dokumen yang Rapih</a></li>
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Komunitas yang Aktif dan Solid</a></li>
                    <li class="hover:text-black before:content-['#'] before:mr-2 lg:before:content-none"><a href="#">Kesimpulan</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div class="">
                <img src="{{ asset('dist/img/blog/thumb-example.png') }}" alt="" class="w-full aspect-video rounded mb-6">
                <div class="">
    ...
    <footer class="container py-16">
        ...
        <div class="w-10/12 mx-auto">
            <div class="flex flex-col items-center justify-center gap-6 lg:gap-16 lg:flex-row">
                <div class="order-2 lg:order-1 flex opacity-60 gap-2.5 social-media">
                ...
                <div class="order-3 font-semibold text-center contact text-black/70">
                    <div class="mb-2.5 text-sm lg:text-lg">
                        contact@deftzone.id
                    </div>
                    <div class="flex gap-1 text-sm lg:gap-2 lg:text-base">
                        <span>
        ...
        <div class="text-center">
            <span class="text-sm font-medium lg:text-base text-black/70">
