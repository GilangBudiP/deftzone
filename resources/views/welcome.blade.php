    ...
    <div class="container flex flex-col bg-right-bottom bg-no-repeat bg-none md:bg-header md:flex-row">
        <div class="w-full my-20 md:w-1/2">
            ...
            <div class="flex gap-3 py-9">
                <button class="px-5 py-3 font-medium text-white transition-colors bg-black border border-black rounded hover:bg-white hover:text-black">
                    Get Started
                </button>
                <a href="#" class="relative px-6 py-3 text-black group">
                    <span class="absolute inset-0 w-full h-full transition duration-300 ease-out transform translate-x-1.5 translate-y-1.5 rounded bg-sky-400/50 group-hover:translate-x-0 group-hover:translate-y-0"></span>
        ...
        <div class="flex w-full p-16 text-white bg-black rounded-3xl">
            ...
            <div class="flex gap-6 p-3">
                <div class="">
                    ...
                    <span class="uppercase text-[8px] font-bold bg-green-500 text-white py-1 px-3 rounded-full">Available</span>
                </div>
                <div>
    ...
    <div class="container">
        <div class="flex justify-start gap-6 py-16">
            ...
            <div class="w-4/12">
                ...
                <p class="mb-6 text-xl font-semibold text-black/70">Berkat pengetahuan mendalam kami dalam pemasaran digital, kami akan membantu Brand Anda mencapai visibilitas yang tak terbantahkan di era digital.</p>
                <p class="mb-6 text-xl font-semibold text-black/70">Dengan strategi yang terarah dan kreatif, kami akan memperluas jangkauan dan daya tarik Brand Anda secara maksimal.</p>
            </div>
        </div>
    </div>
    <div class="container bg-gradient-to-br from-[#E9FAF7] via-white to-[#E8F2FC]">
    ...
    <div class="container">
        <div class="flex justify-start gap-6 py-16">
            ...
            <div class="w-4/12">
                ...
                <p class="mb-6 text-xl font-semibold text-black/70">From captivating logos to stunning visuals, we create compelling designs that resonate with your target audience and leave a lasting impression.</p>
            </div>
        </div>
    </div>
    <div class="container bg-gradient-to-br from-[#E9FAF7] via-white to-[#E8F2FC]">
    ...
    <div class="container py-16">
        <div class="p-16 relative rounded-3xl text-center bg-gradient-to-br from-[#79E5B5] to-[#94E1A6] text-white">
            ...
            <div class="flex justify-center gap-3">
                <button class="px-5 py-3 font-medium text-white transition-colors bg-black border border-black rounded hover:bg-transparent hover:text-black">
                    Get Started
                </button>
                <a href="#_" class="relative px-6 py-3 text-black group">
                    <span class="absolute inset-0 w-full h-full transition duration-300 ease-out transform translate-x-1.5 translate-y-1.5 bg-white rounded group-hover:translate-x-0 group-hover:translate-y-0"></span>
