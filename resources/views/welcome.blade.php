    ...
    <div class="container">
        <div class="flex justify-start gap-6 py-16">
            ...
            <div class="w-4/12">
                ...
                <p class="mb-6 text-xl font-semibold text-black/70">With targeted and creative strategies, we aim to expand your Brand's reach and appeal to the fullest.</p>
            </div>
        </div>
    </div>
