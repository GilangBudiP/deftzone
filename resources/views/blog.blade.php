...
<body class="relative font-inter">
    <!-- Navbar -->
    <nav class="container top-0 fixed z-40 bg-gradient-to-b from-white to-white/50 flex flex-row items-center justify-between py-6 md:relative md:py-10">
    ...
    <div class="container grid grid-cols-3 gap-10">
        <div class="flex flex-col order-2 md:order-1 col-span-3 md:col-span-2 gap-6">
            <a href="#" class="flex flex-col w-full recent-post group">
                <img src="{{ asset('dist/img/blog/thumb-example.png') }}" alt="" class="w-full mb-6 rounded aspect-video group-hover:shadow-lg">
                <div class="flex flex-col gap-6 description">
                    <div class="flex items-center gap-3">
                        <span class="inline-block px-4 py-1 text-xs font-semibold text-white capitalize bg-red-600 rounded-full">news</span>
                        <span class="text-xs font-medium">June 21st, 2023</span>
                    </div>
                    <div>
                        <h3>
            ...
            <a href="#" class="flex flex-col md:flex-row items-center w-full gap-6 group">
                <div class="w-full md:w-5/12">
                    <img src="{{ asset('dist/img/blog/thumb-example.png') }}" alt="" class="w-full mb-6 rounded aspect-video group-hover:shadow-lg">
                </div>
                <div class="w-full flex flex-col md:w-7/12 gap-2 description">
                    <div class="flex items-center gap-3">
                        <span class="inline-block px-4 py-1 text-xs font-semibold text-white capitalize bg-purple-600 rounded-full">Packages</span>
                        <span class="text-xs font-medium">July 7st, 2023</span>
                    </div>
                    <div>
                        <h3>
            ...
            <a href="#" class="flex flex-col md:flex-row items-center w-full gap-6 group">
                ...
                <div class="flex flex-col w-full md:w-7/12 gap-2 description">
                    <div class="flex items-center gap-3">
                        <span class="inline-block px-4 py-1 text-xs font-semibold text-white capitalize bg-purple-600 rounded-full">Packages</span>
                        <span class="text-xs font-medium">July 7st, 2023</span>
                    </div>
            ...
            <div class="pagination">
                <nav class="w-full py-4">
                    <ul class="flex flex-row gap-2.5 justify-center items-center font-medium text-base">
                        ...
                        <li class="w-8 h-8 rounded-full justify-center flex items-center bg-sky-400"><span class="text-white">1</span></li>
                        <li><a href="#" class="text-black w-8 h-8 rounded-full justify-center flex items-center hover:bg-black/5">2</a></li>
                        <li><a href="#" class="text-black w-8 h-8 rounded-full justify-center flex items-center hover:bg-black/5">3</a></li>
                        <li><span class="text-black">...</span></li>
                        <li><a href="#" class="text-black w-8 h-8 rounded-full justify-center flex items-center hover:bg-black/5">5</a></li>
                        <li>
                            <a href="#">&rsaquo;</a>
                        </li>
                    </ul>
        ...
        <div class="col-span-3 order-1 md:order-2 md:col-span-1">
            <div class="p-4 md:p-8 rounded-lg border md:border-none" x-data="{ show: false }">
                ...
                <ul class="space-y-2.5 text-sm md:text-base font-semibold mt-6 text-black/70 md:!block" style="display: none" x-show="show" x-transition>
                    <li class="hover:text-black"><a href="#">Technology</a></li>
                    <li class="hover:text-black"><a href="#">Web Design</a></li>
                    <li class="hover:text-black"><a href="#">News</a></li>
                    <li class="hover:text-black"><a href="#">Development</a></li>
                    <li class="hover:text-black"><a href="#">Lifestyle</a></li>
                    <li class="hover:text-black"><a href="#">Tutorial</a></li>
                </ul>
            </div>
        </div>
    </div>
